...
with gr.Blocks() as iface:
    with gr.Row():
        url_input = gr.Textbox(label="Enter YouTube URL", placeholder="Enter the YouTube video URL here...")
        query_input = gr.Textbox(label="Enter Your Question", placeholder="Enter your question here...")
    ...
    gr.Button("Submit").click(process_query, inputs=[url_input, query_input], outputs=output)
